...
//	
	...
	public void deleteAccountTest() {
		...
		// delete an account who had both set up their profile and education background
		assertTrue(C206_CaseStudy.deleteAccount(1, usersList, profileList, educationBackgroundList));
	}
